...
int wakeSM(int state)
{
    ...
    switch(state)
    {
        case WAKE_WAIT: break; 
        case WAKE_HELD: break;
    }
...
int main(void) 
{
    ...
    wakeTask.state = WAKE_WAIT;
    wakeTask.period = 50;
    wakeTask.elapsedTime = wakeTask.period;
    wakeTask.TickFct = &wakeSM;
    wakeTask.active = 0x01;
